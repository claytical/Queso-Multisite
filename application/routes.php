...
Route::get('user/join', array('uses' => 'user@join_team'));
Route::post('user/join', array('uses' => 'user@join_team'));
...
Route::get('admin/teams', array('uses' => 'team@index'));
Route::post('admin/teams', array('uses' => 'team@index'));
Route::post('admin/team/edit', array('uses' => 'team@edit'));
Route::get('admin/team/delete/(:num)', array('uses' => 'team@delete'));
...
Route::get('admin/post/sticky/(:any)', array('uses' => 'post@sticky'));
Route::get('admin/post/unstick/(:any)', array('uses' => 'post@unstick'));
