...
<?php echo Form::open('register', 'POST', array('class' => 'form-horizontal well')); ?>
	<fieldset>
	...
	<div class="control-group">	
	    <?php echo Form::label('regcode', 'Course Code', array('class' => 'control-label')); ?>
			<div class="controls">
    			<?php echo Form::text('regcode', Input::get('id')); ?>
			</div>
	</div>
